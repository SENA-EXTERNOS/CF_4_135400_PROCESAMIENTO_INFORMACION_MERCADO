          ...
          LineaTiempoD.color-acento-contenido
            .row(numero="1" titulo="Prestar atención y valorar la situación ")
              .col-md-10.mb-4.mb-md-0
                p.text-small Antes de incluirse dentro de una conversación, o ser parte de esta, es importante estudiar el contexto en el que se desarrolla para evitar malentendidos, en especial si es sobre política, asuntos personales o religión, entre otros temas delicados.
              

            .row(numero="2" titulo="Ser sencillo (no usar tecnicismos) ")
              
              .col-md-10.mb-4.mb-md-0
                p.text-small En este punto es importante tener en cuenta con qué personas se está llevando a cabo la conversación, ya que, si todos conocen el tema, se podrá recurrir a terminología específica, de lo contrario es mejor usar un lenguaje sencillo.
            
            .row(numero="3" titulo="Cuidar el lenguaje no verbal ")
              
              .col-md-10.mb-4.mb-md-0
                p.text-small La postura y el tono de voz van ligados directamente a la forma como nos comunicamos. Por esa razón el lenguaje no verbal se debe cuidar, con el fin de evitar molestias o dar la imagen equivocada. El contacto visual, el tono de voz muy alto, o muy bajo, pueden afectar la comunicación.

            .row(numero="3" titulo="Respeto y coherencia  ")              
              .col-md-10.mb-4.mb-md-0
                p.text-small Todos los seres humanos piensan y actúan de forma diferente, por ello es necesario incluir el respeto dentro de una buena comunicación. Otro factor primordial es la coherencia, para evitar malentendidos y problemas de interpretación.

            .row(numero="3" titulo="Manejar los sentimientos ")              
              .col-md-6.mb-4.mb-md-0
                p.text-small Aprender a controlar los sentimientos es clave a la hora de comunicarnos. Dejarse llevar por la ira o el enfado, mostrar ironía o reírse en el momento menos oportuno puede enrarecer el ambiente comunicativo y echar a perder un negocio, el alcance de un cliente e incluso una amistad.  

            .row(numero="3" titulo="Validar la comprensión del mensaje  ")              
              .col-md-10.mb-4.mb-md-0
                p.text-small Es importante asegurarse de que el mensaje fue lo suficientemente claro y que se entendió. Para ello es bueno preguntar directamente si se tienen dudas o comentarios sobre lo comunicado.
